function c = graphAdjacencyMatrixToConnectedComponents(a)
%
% c = graphAdjacencyMatrixToConnectedComponents(a)
% 
% description:
...
[n, m] = size(a);
if n ~= m
   error ('graphAdjacencyMatrixToConnectedComponents: Adjacency matrix must be square!')
end;

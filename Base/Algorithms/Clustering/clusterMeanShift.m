function [clpos, clids, cls] = clusterMeanShift(pts, ksize)
%
% [clpos,clids,cls] = clusterMeanShift(pts, ksize)
%
% description:
%     mean shift clustering on pts using using a flat kernel of size ksize
%
% input:

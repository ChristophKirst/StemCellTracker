function fileExt = bffileextensions
%
% fileExt = bffileextensions
%
% description:
%     list all extensions supported by Bio-Formats
%
% output:
%      fileExt:  a cell array of dimensions n x2 where the first colum
%      gives the extension and the second the name of the corresponding format.
%      This cell array is formatted to be used with uigetfile funciton.
%
% note: modified from bfmatlab package
%
% See also: imread_bf, bfinitialize

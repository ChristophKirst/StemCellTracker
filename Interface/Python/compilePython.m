...
if isunix() && ~ismac
   ...
   mkdir('/tmp/matpy');
   %compile
   [stat, cmdout] = system('/usr/bin/g++ -c -D_GNU_SOURCE -DMATLAB_MEX_FILE  -I"/usr/local/MATLAB/R2014a/extern/include" -I"/usr/local/MATLAB/R2014a/simulink/include" -ansi -fexceptions -fPIC -fno-omit-frame-pointer -pthread -O -DNDEBUG ./Interface/Python/py.cpp -o /tmp/matpy/py.o')
   %link

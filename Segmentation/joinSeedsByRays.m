...
figure(32)
implottiling({imoverlay(image, label), gradient})
...
[pairs, dist] = imlabellocalpairs(label, cutoff_distance, 'distance');


% plot
np = length(pairs)
pos = immask2coords(label > 0);


figure(43)
clf
implot(imoverlay(image, label))

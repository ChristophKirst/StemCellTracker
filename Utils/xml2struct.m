...
%
% out = xml2struct(xmlfile)
%
% description:
%     parses an xml file to a struc
%
% input: 
%     xmlfile  filename of xml file
%
% output:
%     out      struct with structure as in the xml file

% based on code by By Douglas M. Schwarz, douglas.schwarz@kodak.com

function img = stichImagesByMean(imgs, shifts)
%
% img = stichImagesByMean(imgs, shifts)
%
% description:
%     stiches images in cell array imgs together using shifts and mean in overlapping 
%     regions
%
% input:

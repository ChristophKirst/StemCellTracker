...
channellabel  = {'CTIP2', 'TLE4', 'SATB2', 'NURR1', 'DAPI'};
...
imgMeasure = {img{1}, imgRaw{2}, img{3}, img{4}, imgRaw{5}};
statsMeasure = {statsCh{1}, statsChRaw{2}, statsCh{3}, statsCh{4}, statsChRaw{5}};
...
nzones = length(zonelineshires) - 1;
...
class_thresholds = {0.16, 0.25, 0.16, 0.18, 0};

...
load('./Test/Images/Develop/Aryeh/140305_RUES2_36hBMP4_Bra_Snail_Sox2_segmetation_2_stats.mat')
load('./Test/Images/Develop/Aryeh/140305_RUES2_36hBMP4_Bra_Snail_Sox2_segmetation_2_stats_ch2.mat')
load('./Test/Images/Develop/Aryeh/140305_RUES2_36hBMP4_Bra_Snail_Sox2_segmetation_2_stats_ch3.mat')
load('./Test/Images/Develop/Aryeh/140305_RUES2_36hBMP4_Bra_Snail_Sox2_segmetation_2_stats_ch4.mat')
%%

load('./Test/Images/Develop/Aryeh/140305_RUES2_36hBMP4_Bra_Snail_Sox2_segmetation_2.mat')

%%

labels = imlabel(imgseg);
length(labels)
...
if verbose
   ...
   figure(46)
   clf
   set(gcf, 'Name', ['channel 2']);
   for i = 1:4
      ax(i) = subplot(2,2,i);
      plot([stats2.(xmeasure)], [stats2.(ymeasures{i})], '*r');
      xlabel(xmeasure); ylabel(ymeasures{i});
   end
   linkaxes(ax, 'x')
   ...
   for i = 1:4
      ax(i) = subplot(2,2,i);
      plot([stats2.(xmeasure)], [stats2.(ymeasures{i})], '*g');
      xlabel(xmeasure); ylabel(ymeasures{i});
   end
   linkaxes(ax, 'x')
   ...
   figure(48)
   clf
   set(gcf, 'Name', ['channel 3']);
   for i = 1:4
      ax(i) = subplot(2,2,i);
      plot([stats3.(xmeasure)], [stats3.(ymeasures{i})], '*r');
      xlabel(xmeasure); ylabel(ymeasures{i});
   end
   linkaxes(ax, 'x')
   ...
   figure(49)
   clf
   set(gcf, 'Name', ['channel 4']);
   for i = 1:4
      ax(i) = subplot(2,2,i);
      plot([stats4.(xmeasure)], [stats4.(ymeasures{i})], '*k');
      xlabel(xmeasure); ylabel(ymeasures{i});
   end
   linkaxes(ax, 'x')
...
if verbose
   ...
   for i = 1:4
      ax(i) = subplot(2,2,i);
      plot(xdata, [stats2.(ymeasures{i})], '*g');
      xlabel(xmeasure); ylabel(ymeasures{i});
   end
   linkaxes(ax, 'x')
   ...
   for i = 1:4
      ax(i) = subplot(2,2,i);
      plot(xdata, [stats3.(ymeasures{i})], '*r');
      xlabel(xmeasure); ylabel(ymeasures{i});
   end
   linkaxes(ax, 'x')
   ...
   for i = 1:4
      ax(i) = subplot(2,2,i);
      plot(xdata, [stats4.(ymeasures{i})], '*k');
      xlabel(xmeasure); ylabel(ymeasures{i});
   end
   linkaxes(ax, 'x')

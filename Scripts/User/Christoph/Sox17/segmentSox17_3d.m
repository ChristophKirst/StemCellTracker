...
img = exp.readImage('field', 25, 'time', 4, 'zpos', 1);
size(img)
...
img = imread_stack(exp.ImageFile('field', 10, 'time', t, 'zpos', '**'));
size(img)
...
%% Loop over Time
tagrange = exp.findImageTagRange;
...
filenames = exp.ImageFile('field', 10, 'time', t, 'zpos', '**');

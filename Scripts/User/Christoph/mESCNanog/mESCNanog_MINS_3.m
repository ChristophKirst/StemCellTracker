...
datadir = '/data/Science/Projects/StemCells/Experiment/Mouse/Nanog/29Jul14FGFonNanogH2BGFP/';


%dexp = 'T<F,3>/T<F,3>.tif';
%fulldexp = fullfile(datadir, dexp);
fulldexp = fullfile(datadir, '29Jul14FGFonNanogH2BGFP_movie.lsm');
...
resultdir = '/data/Science/Projects/StemCells/Experiment/Mouse/Nanog/29Jul14FGFonNanogH2BGFP/29Jul14FGFonNanogH2BGFP_MINS_2/';
fexp = '29Jul14FGFonNanogH2BGFP_movie_channel=0001_frame=<F,4>_segmentation.tiff';

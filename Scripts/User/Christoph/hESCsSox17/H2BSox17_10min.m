...
%%
fns =  '/data/Science/Projects/StemCells/Experiment/FateDynamics/Sox17_10min/MIP/W1F<F,3>T<T,4>Z<Z,2>C<C,1>.tif';
flds = 33:48;
...
for t = 1:72 %155
   fprintf('t = %d\n', t);
   for f = flds
      img = double(imread(tagExpressionToString(fns, 'C', 1, 'T', t, 'F', f, 'Z', 0)));

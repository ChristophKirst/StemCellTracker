%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Serial Detection of Colonies in a CZI file
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fname = './Test/Images/hESCells_DAPI.czi'

is = ImageSourceBF(fname);
is.printInfo


%% Manual Hack to make tiling work
%is.setReshape('S', 'UV', [4,4]);
%is.setRange('U', 1:4, 'V', 1:2)

imgs = is.cell(1:2:15)';
imgs = imfrmtReshapeCellData(imgs, 'XY', 'S', 'XY', 'Uv', {'S'}, {'UV'}, {[4,2]});
...
%auto tiling detection -> not working for multiple positions !!
...
if verbose
   figure(1); clf
   implot(stitchPreview(imgs, 'overlap', 130, 'scale', 0.05, 'lines', false));
end
...
isa = ImageSource(imgs);
isa.printInfo;

%%

algn = Alignment(isa, 'SU');

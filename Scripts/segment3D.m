function [stacksegmented, segmentprops] = segment3D(filenames)
...
datadir = '/var/run/media/ckirst/Seagate Backup Plus Drive/Science/Projects/StemCells/Experiment/Movies/';
f = 1;
filenames = fullfile(datadir, ['W1F188T' num2str0(f, 4) '*C1.tif']);
...
boxr = [1 1 1];
stackraw = imread_stack(filenames);

if verbose
   figure(1)
   clf
   set(gcf, 'Name', ['Raw Stack: ' filenames]);

function img = stitch2ImagesByMean(img1, img2, shift, varargin)
%
% img = stitch2ImagesByMean(img1, img2, shift)
%
% description:
%     stitches two images of same size together, calculating 
%     the mean in the overlapping area
%
% input:

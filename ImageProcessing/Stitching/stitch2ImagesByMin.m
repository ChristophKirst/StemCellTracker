function img = stitch2ImagesByMin(img1, img2, shift, varargin)
%
% img = stitch2ImagesByMin(img1, img2, shift)
%
% description:
%     stitches two images of same size together, calculating 
%     the min in the overlapping area
%
% input:

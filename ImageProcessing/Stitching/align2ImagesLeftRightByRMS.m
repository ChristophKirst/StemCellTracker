function [shift, quality] = align2ImagesLeftRightByRMS(img1, img2, varargin)
%
% shift = align2ImagesLeftRightByRMS(img1, img2, param)
%
% description: 
%     aligns two images using overlap weighted squared error calculated via fft
...
s1fft = fftn(img1c .* img1c);  s2fft = fftn(img2c .* img2c);
...
[quality, pos] = min(cc(:));
quality = - quality; % higher quality values indicate the better alignment

function [info, pos] = tileshapeFromZVI(fname)
%
% ts = tileshapeFromZvi(fname)
%
% description:
%     tries to infer the tile shape form a Zvi file
%
% input:
...
cl = meanShiftCluster(xpos, is(1)/2);
ntx = length(cl);
...
cl = meanShiftCluster(ypos, is(2)/2);
nty = length(cl);

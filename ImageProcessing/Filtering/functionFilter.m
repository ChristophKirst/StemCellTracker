function out = functionFilter(img, ksize, func, padding, chunkfactor)
%
% out = functionFilter(img, ksize, func, padding)
%
% description:
...
if d < 1 || d > 3
   error('functionFilter: img should be 1d, 2d or 3d gray scale img')
end

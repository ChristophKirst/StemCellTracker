function out = meanShiftFilter(image, ksize, intensity_width, iterations, padding)
%
% out = meanShiftFilter( image, ksize, intensity_width, iterations, padding )
%
% description:
...
%     out               filtered image
%
% See also: bilateralFilter, medianFilter
...
if dim < 2 || dim > 4
   error('meanShiftFilter: expect 2d or 3d gray scale image!');
end

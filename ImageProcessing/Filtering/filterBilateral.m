function out = filterBilateral(image, ksize, sigma_space, sigma_intensity, padding)
%
% out = filterBilateral(image, hsize sigma_space, sigma_intensity, padding)
%
% description:
...
%
% See also: filterMeanShift, filterLinear
...
if dim < 2 || dim > 4
   error('filterBilateral: expect 2d or 3d gray scale image');
end
...
if nargin < 3
   sigma_space = ksize /(2 * sqrt(2 * log(2)));
end
